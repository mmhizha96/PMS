    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($recipient) {
                ...
                $nortification->message = "<h5>Work Approval</h5><p><span class='message'>Some work has been uploaded padding your approval</span></p>
                <a class='message-footer' href='actualsToApprove' >Click&nbsp;here&nbsp;</a></p>";
